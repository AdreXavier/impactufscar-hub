  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 pb-24 p-6 lg:p-10">
      ...
      <div className="space-y-4">
        ...
        {/* Video Area */}
        <div className="aspect-video w-full rounded-2xl bg-slate-800/60 border border-slate-700/50 flex items-center justify-center group cursor-pointer overflow-hidden relative">
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
          <div className="w-20 h-20 rounded-full bg-indigo-500/20 flex items-center justify-center text-indigo-400 transform group-hover:scale-110 transition-transform duration-300 z-10 shadow-2xl border border-indigo-500/30">
